...
import me.prince.service.DepartmentService;
...
public class DepartmentResourceIntTest {
    ...
    private static final String DEFAULT_REMARKS = "AAAAAA";
    private static final String UPDATED_REMARKS = "BBBBBB";
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRemarks()).isEqualTo(UPDATED_REMARKS);
    }
